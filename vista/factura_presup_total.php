...
if(isset($_GET['IdPresupuesto'])){
    ...
    //por último ejecuto la función 'generarFacturaDePresupuesto' con los datos formateados
    $IdFactura=$clsCNContabilidad->generarFacturaDePresupuesto($_SESSION['usuario'],$datosFormateados);

...
<form name="form1" action="../vista/facturalist.php" method="get">
    ...
    <tr></tr>
            ...
            <?php
                $arResult=$clsCNContabilidad->ListadoFacturasRectificativas($_GET['strNomContacto'],$_GET['estado'],$_GET['ejercicio']);
                ...
                <tbody>
                    ...
                    if(is_array($arResult)){
                        for ($i = 0; $i < count($arResult); $i++) {
                            ...
                            $link="javascript:document.location.href='../vista/altafactura_rectificativa.php?IdFactura=".$arResult[$i]['IdFactura']."';";
...
<!--                                <td onClick="<?php //echo $link; ?>"><?php //echo " ".$arResult[$i]['NumPresupuesto']." ".$numeroPresupuesto; ?></td>
                                ...
                                <td onClick="<?php echo $link; ?>"><?php echo $arResult[$i]['Situacion']; ?></td>

...
//        echo '<META HTTP-EQUIV=Refresh CONTENT="0; URL=../vista/gastos_exito.php?op=SF&datos='.$compactada.'&esAbono='.$_POST["esAbono"].'">';
        echo '<META HTTP-EQUIV=Refresh CONTENT="0; URL=../vista/gastos_exito.php?op=SF&tipo='.$_POST['tipo'].'">';
    }
}
...
?>
  <div class="doc"> 
    <hr color = "#FF9900">
    <br/>
    <form name="form1" method="post" action="../vista/gastos_SF.php">
      ...
      <table width="640" border="0" class="zonaactiva">
        ...
        <tr> 
          ...
          <td colspan="2">
            ...
            <input class="textbox1" type="text" id="datFecha" name="datFecha" maxlength="38" placeholder="<?php if(isset($datos['datFecha'])){echo $datos['datFecha'];}else {echo $fechaForm;}?>" 
...
function borrarAsiento(id){
    ...
    <div data-role="content" data-theme="a">
        <form action="../vista/gastos_SF.php" name="form1" method="POST" data-ajax="false">
                    ...
                    <tr> 
                      <td colspan="4">
                          <div align="left">
                            ...
                            <input type="text" id="strCuentaCli" name="strCuentaCli" tabindex="3" value="<?php echo htmlentities($datos['strCuentaCli'],ENT_QUOTES,'UTF-8');?>"
                                 onKeyUp="comprobarCuenta(this,document.getElementById('okStrCuentaCli'));"  

...
//    op='<?php //echo $_GET['op'];?>';
//    if(op==='SF'){
//        window.location='../vista/ingresos_SF.php?datos=<?php //echo $_GET['datos'];?>&esAbono=<?php //echo $_GET['esAbono'];?>';
//    }else if(op==='CFIVA1SIRPF'){
//        window.location='../vista/ingresos_CFIVA1SIRPF.php?datos=<?php //echo $_GET['datos'];?>&esAbono=<?php //echo $_GET['esAbono'];?>';
//    }else if(op==='CFIVA1CIRPF'){
//        window.location='../vista/ingresos_CFIVA1CIRPF.php?datos=<?php //echo $_GET['datos'];?>&esAbono=<?php //echo $_GET['esAbono'];?>';
//    }else if(op==='CFIVAV'){
//        window.location='../vista/ingresos_CFIVAV.php?datos=<?php //echo $_GET['datos'];?>&esAbono=<?php //echo $_GET['esAbono'];?>';
//    }    
//}
...
function nuevoAsiento(){
    op='<?php echo $_GET['op'];?>';
    if(op==='SF'){
        window.location='../vista/ingresos_SF.php?esAbono=NO';
    }else if(op==='CFIVA1SIRPF'){
        window.location='../vista/ingresos_CFIVA1SIRPF.php?esAbono=NO';
    }else if(op==='CFIVA1CIRPF'){
        window.location='../vista/ingresos_CFIVA1CIRPF.php?esAbono=NO';
    }else if(op==='CFIVAV'){
        window.location='../vista/ingresos_CFIVAV.php?esAbono=NO';
    }else if(op==='CFIVAVCIRPF'){
        window.location='../vista/ingresos_CFIVAVCIRPF.php?esAbono=NO';
    }else if(op==='2'){
...
?>	    
  ...
  <tr height="40">
      <td width="40%">
          <div align="right">
<!--              <a href="../vista/default2.php">
                  <input class="button" type="button" name="eleccion" value="Inicio"/>-->

...
<html>
    <head>
        ...
        <title>I.R.P.F. Liquidaciones Presentadas</title>
...
<table align="center">
    ...
    <h3 align="center" color="#FFCC66">
        <font size="3px">I.R.P.F. Listado Liquidaciones Presentadas</font>
    </h3> 
            <?php
                ...
                $arResult=$clsCNContabilidad->ListadoIRPF111_Presentados($_SESSION['idEmp']);
                ...
                <tbody>
                    ...
                    if(is_array($arResult)){
                        for ($i = 0; $i < count($arResult); $i++) {
                            $link="javascript:document.location.href='../vista/irpf_datosVer.php?IdFichero=".$arResult[$i]."';";

...
$datosPresentar=array(
    ...
    "21"=>$clsCNContabilidad->pasarNumeroFichero(substr($textos,339,17)),
    "22"=>$clsCNContabilidad->pasarNumeroFichero(substr($textos,356,17)),
    "23"=>$clsCNContabilidad->pasarNumeroFichero(substr($textos,373,17)),
    "38"=>$clsCNContabilidad->pasarNumeroFichero(substr($textos,628,17)),
    "41"=>$clsCNContabilidad->pasarNumeroFichero(substr($textos,667,17)),
    "48"=>$clsCNContabilidad->pasarNumeroFichero(substr($textos,786,17)),

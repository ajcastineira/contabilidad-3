...
if(isset($_POST['cmdAlta']) && $_POST['cmdAlta']=='Aceptar'){
    ...
    logger('traza','iva_303.php-' ,"Usuario: ".$_SESSION['strUsuario'].', Empresa: '.$_SESSION['mapeo'].', SesionID: '.  session_id().
           " clsCNContabilidad->guardarTrimestre(".$_POST['Ejercicio'].",".$_POST['Trimestre'].",".$_POST['casilla27'].",
                                         ".$_POST['casilla29'].",".$_POST['casilla67'].")>");
    $varRes=$clsCNContabilidad->guardarTrimestre($_POST['Ejercicio'],$_POST['Trimestre'],$_POST['casilla27'],
                                         $_POST['casilla29'],$_POST['casilla67']);
    ...
    if($varRes<>1){
        ...
        $datosBancarios=array(
            ...
            'cuentaBanco_IBAN'=>$_POST['cuentaBanco_IBAN'],
...
function activaCampoCBanco(objeto){
    if(objeto.checked===true){
        ...
        document.form1.cuentaBanco_IBAN.disabled=false;
        ...
        document.form1.cuentaBanco_IBAN.disabled=true;
    ...
    <form name="form1" method="post" action="../vista/iva_303.php">
      ...
      <table width="640" border="0" class="zonaactivaiva">
        ...
        <tr>
            ...
            <td>
                <label><div align="right">27</div></label>
            </td>
            <td>
                <input class="textbox1" type="text" style="text-align:right;"
                       value="<?php echo $datosPresentar['27'];?>" readonly />
            </td>
            <td></td>
        </tr>
      ...
      <table width="640" border="0" class="zonaactivaiva">
        ...
        <tr>
            ...
            <td>
                <input class="textbox1" type="text" style="text-align:right;"
                       value="<?php echo $datosPresentar['28a'];?>" readonly />
            </td>
            <td>
                <label><div align="right"></div></label>
            </td>
            <td>
                <input class="textbox1" type="text" style="text-align:right;"
                       value="<?php echo $datosPresentar['28aIVA'];?>" readonly />
            </td>
            <td>
                <label><div align="right"></div></label>
            </td>
            <td>
                <input class="textbox1" type="text" style="text-align:right;"
                       value="<?php echo $datosPresentar['29a'];?>" readonly />
            </td>
            <td></td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input class="textbox1" type="text" style="text-align:right;"
                       value="<?php echo $datosPresentar['28b'];?>" readonly />
            </td>
            <td>
                <label><div align="right"></div></label>
            </td>
            <td>
                <input class="textbox1" type="text" style="text-align:right;"
                       value="<?php echo $datosPresentar['28bIVA'];?>" readonly />
            </td>
            <td>
                <label><div align="right"></div></label>
            </td>
            <td>
                <input class="textbox1" type="text" style="text-align:right;"
                       value="<?php echo $datosPresentar['29b'];?>" readonly />
            </td>
            <td></td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input class="textbox1" type="text" style="text-align:right;"
                       value="<?php echo $datosPresentar['28c'];?>" readonly />
            </td>
            <td>
                <label><div align="right"></div></label>
            </td>
            <td>
                <input class="textbox1" type="text" style="text-align:right;"
                       value="<?php echo $datosPresentar['28cIVA'];?>" readonly />
            </td>
            <td>
                <label><div align="right"></div></label>
            </td>
            <td>
                <input class="textbox1" type="text" style="text-align:right;"
                       value="<?php echo $datosPresentar['29c'];?>" readonly />
            </td>
            <td></td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input class="textbox1" type="text" style="text-align:right;"
                       value="<?php echo $datosPresentar['28d'];?>" readonly />
            </td>
            <td>
                <label><div align="right"></div></label>
            </td>
            <td>
                <input class="textbox1" type="text" style="text-align:right;"
                       value="<?php echo $datosPresentar['28dIVA'];?>" readonly />
            </td>
            <td>
                <label><div align="right"></div></label>
            </td>
            <td>
                <input class="textbox1" type="text" style="text-align:right;"
                       value="<?php echo $datosPresentar['29d'];?>" readonly />
            </td>
            <td></td>
        </tr>
        ...
        <tr>
            <td>
                <label class="nombreCampo"><div align="right">Total &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 28</div></label>
            </td>
            <td>
                <input class="textbox1" type="text" style="text-align:right;"
                       value="<?php echo $datosPresentar['28'];?>" readonly />
            </td>
            <td>
                <label><div align="right"></div></label>
            </td>
            ...
            <td>
                <label><div align="right">29</div></label>
            </td>
            <td>
                <input class="textbox1" type="text" style="text-align:right;"
                       value="<?php echo $datosPresentar['29'];?>" readonly />
            </td>
            <td></td>
        </tr>
      ...
      <table width="640" border="0" class="zonaactivaiva">
        ...
        <tr>
            ...
            <td><label><div align="right">46</div></label></td>
            <td>
                <input class="textbox1" type="text" style="text-align:right;"
                       value="<?php echo $datosPresentar['46'];?>" readonly />
            </td>
            <td></td>
        </tr>
        ...
        <tr>
            ...
            <td><label><div align="right">67</div></label></td>
            <td>
                <input class="textbox1" type="text" style="text-align:right;"
                       value="<?php echo $datosPresentar['67'];?>" readonly />
            </td>
            <td></td>
        </tr>
        ...
        <tr>
            ...
            <td><label><div align="right">71</div></label></td>
            <td>
                <input class="textbox1" type="text" style="text-align:right;"
                       value="<?php echo $datosPresentar['71'];?>" readonly />
            </td>
            <td></td>
        </tr>
      ...
      <table width="640" border="0" class="zonaactivaiva">
        ...
        <tr>
            ...
            <td>
                <input class="textbox1" name="cuentaBanco_IBAN" type="text" maxlength="4" 
                       onkeypress="" style="text-align:right;" disabled />
            </td>
            <td>
        ...
        <tr>
            <td>
                ...
                if($datosPresentar['27']==='0,00' && $datosPresentar['28']==='0,00' && $datosPresentar['29']==='0,00' &&
                   $datosPresentar['46']==='0,00' && $datosPresentar['67']==='0,00' && $datosPresentar['71']==='0,00'){
                ?>
      ...
      <table width="640" border="0" class="zonaactivaiva">
          ...
          <tr>
              <td colspan="5">
                  <div align="center">
                    ...
                    <label class="nombreCampo">Desea Transmitir la liquidación de I.V.A.</label>
                  </div>
              </td>
          </tr>
          ...
          <tr>
              ...
              <td>
                  ...
                  <input type="hidden" name="casilla27" value="<?php echo $datosPresentar['27']; ?>" />
                  <input type="hidden" name="casilla29" value="<?php echo $datosPresentar['29']; ?>" />
                  <input type="hidden" name="casilla67" value="<?php echo $datosPresentar['67']; ?>" />

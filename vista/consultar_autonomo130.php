...
logger('info',basename($_SERVER['PHP_SELF']) ,"Usuario: ".$_SESSION['strUsuario'].', Empresa: '.$_SESSION['strBD'].', SesionID: '.  session_id().
       " ||||Consultas->Autonomos->Presentados||");
...
<html>
    <head>
        ...
        <title>Pagos a Cuenta Presentadas</title>
...
<table align="center">
    ...
    <h3 align="center" color="#FFCC66">
        <font size="3px">Pagos a Cuenta Presentadas</font>
    </h3> 
            <?php
                ...
                $arResult=$clsCNContabilidad->ListadoAutonomo130_Presentados($_SESSION['idEmp']);
                ...
                <tbody>
                    ...
                    if(is_array($arResult)){
                        for ($i = 0; $i < count($arResult); $i++) {
                            $link="javascript:document.location.href='../vista/autonomo130_datosVer.php?IdFichero=".$arResult[$i]."';";

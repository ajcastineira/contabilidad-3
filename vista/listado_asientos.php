...
<html>
    <head>
        ...
        <title>Modificar Asiento - Listar Cuentas</title>
...
<form name="form1" action="../vista/listado_asientos.php" method="get">
...
<!--            <h3 align="center" color="#FFCC66"><font size="3px">Listado de Cuentas</font></h3>-->
            <br/>
            <table id="datatablesMod" class="display" border="0">
                <thead>
                    <tr>
                        <th>Cuenta</th>
                        <th>Nombre</th>
...
?>
    ...
    <body>
    <div data-role="page" id="listado_asientos">
    <?php
    eventosInputText();
    ?>
            ...
            if(is_array($arResult)){
                for ($i = 0; $i < count($arResult); $i++) {
                    ...
                    <li onClick="<?php echo $link; ?>">
                        ...
                        <?php echo '<font color="30a53b">'.$arResult[$i]['Cuenta'].'</font> - '; ?>

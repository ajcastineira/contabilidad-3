...
if($listadoBBDDLibres==='vacio'){
        echo '<META HTTP-EQUIV=Refresh CONTENT="0; URL=../vista/error.php?id=No existen Bases de Datos libres, se deben de crear nuevas bases de datos antes de dar de alta una nueva empresa.">';die;
}
...
if(isset($_POST['cmdAlta']) && $_POST['cmdAlta']=='Aceptar'){
    logger('info','altaempresa.php-' ,"Usuario: ".$_SESSION['strUsuario'].', Empresa: '.$_SESSION['mapeo'].', SesionID: '.  session_id(). " ||||Configuraciones->Mis Usuario->Alta Empresa|| Ha pulsado 'Proceder a Alta'");
    
    $OK=$clsCNUsu->AltaEmpresaNueva($_POST['strNombre'],$_POST['strCIF'],$_POST['strPassword'],$_POST['strDireccion'],$_POST['strSesion'],$_POST['strMunicipio']
                                    ,$_POST['strCP'],$_POST['strTelefono'],$_POST['email1'],$_POST['email2'],$_POST['version'],$_POST['numApuntes']
                                    ,$_POST['IdAsesor'],$_POST['strMapeo'],$_POST['claseEmpresa']);
    ...
    logger('info','altaempresa.php-' ,"Usuario: ".$_SESSION['strUsuario'].', Empresa: '.$_SESSION['mapeo'].', SesionID: '.  session_id(). " ||||Configuraciones->Mis Usuario->Alta Empresa|| ");
...
?>
    ...
    <hr color = "#FF9900">
    <br/>
    <form name="form1" method="post" action="../vista/altaempresa.php" onSubmit="desactivaBoton()">

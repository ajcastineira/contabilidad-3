...
<!--        <script src='http://ajax.googleapis.com/ajax/libs/jquery/1.8.2/jquery.min.js' type='text/javascript'></script>-->
    ...
    <body bgcolor="#ffffff" onLoad="rotulo_status();nueva('../qualidad/doc-Qualidad/polcal.pdf','polcal', 0);" onResize="if (isNS4) nsResizeHandler();">
        <div align="center">
        <form name="form1">
            <table width="774" height="550" border="0">
                        ...
                        <table id="prueba" border="0" width="701" height="148">
                            <tr> 
                                <td width="954" height="100" align="middle" valign="top" nowrap>
                                    <a href="../vista/defaultAsesor.php">
                ...
                <tr> 
                    <td width="350" height="93" valign="top">
                        ...
                        ?>
                        <table border='0' cellpadding='20' height='240'>
                            <tr>
                                <td><div class='menu_list' id='firstpane' align="left">
                                        <p onmouseover="menuOver(this)" onmouseout="menuOut(this,'<?php echo $fondo1; ?>')" class='menu_head1'><img class="icono" src='../images/01Configuracion.png' /><?php echo $desplazamientoCorto . $textos['a01']; ?></p>
                                        <div class='menu_body2'>
                                            <a onmouseover="menuOver(this)" onmouseout="menuOut(this,'<?php echo $fondo2; ?>')" href='<?php echo urlNavegacion($ficheros['a0101b'],$listFicherosMovil,$navegacion); ?>'><?php echo $desplazamiento . $textos['a0101b']; ?></a>
                                        </div>
                                        <p onmouseover="menuOver(this)" onmouseout="menuOut(this,'<?php echo $fondo1; ?>')" class='menu_head1'><img class="icono" src='../images/01Configuracion.png' /><?php echo $desplazamientoCorto . $textos['a04']; ?></p>
                                        <div class='menu_body2'>
                                            <a onmouseover="menuOver(this)" onmouseout="menuOut(this,'<?php echo $fondo2; ?>')" href='<?php echo urlNavegacion($ficheros['a0401'],$listFicherosMovil,$navegacion); ?>'><?php echo $desplazamiento . $textos['a0401']; ?></a>
                                        </div>
                                        <p onmouseover="menuOver(this)" onmouseout="menuOut(this,'<?php echo $fondo1; ?>')" class='menu_head1'><img class="icono" src='../images/02Operaciones.png' /><?php echo $desplazamientoCorto . $textos['a02']; ?></p>
                                        <div class='menu_body2'>
                                            <a onmouseover="menuOver(this)" onmouseout="menuOut(this,'<?php echo $fondo2; ?>')" href='<?php echo urlNavegacion($ficheros['a0201'],$listFicherosMovil,$navegacion); ?>'><?php echo $desplazamiento . $textos['a0201']; ?></a>
                                            <a onmouseover="menuOver(this)" onmouseout="menuOut(this,'<?php echo $fondo2; ?>')" href='<?php echo urlNavegacion($ficheros['a0202'],$listFicherosMovil,$navegacion); ?>'><?php echo $desplazamiento . $textos['a0202']; ?></a>
                                        </div>
                                        <p onmouseover="menuOver(this)" onmouseout="menuOut(this,'<?php echo $fondo1; ?>')" class='menu_head1'><img class="icono" src='../images/03Consultas.png' /><?php echo $desplazamientoCorto . $textos['a05']; ?></p>
                                        <div class='menu_body2'>
                                            <a onmouseover="menuOver(this)" onmouseout="menuOut(this,'<?php echo $fondo2; ?>')" href='<?php echo urlNavegacion($ficheros['a0501'],$listFicherosMovil,$navegacion); ?>'><?php echo $desplazamiento . $textos['a0501']; ?></a>
                                            <a onmouseover="menuOver(this)" onmouseout="menuOut(this,'<?php echo $fondo2; ?>')" href='<?php echo urlNavegacion($ficheros['a0502'],$listFicherosMovil,$navegacion); ?>'><?php echo $desplazamiento . $textos['a0502']; ?></a>
                                            <a onmouseover="menuOver(this)" onmouseout="menuOut(this,'<?php echo $fondo2; ?>')" href='<?php echo urlNavegacion($ficheros['a0503'],$listFicherosMovil,$navegacion); ?>'><?php echo $desplazamiento . $textos['a0503']; ?></a>
                                        </div>
                                        <p onmouseover="menuOver(this)" onmouseout="menuOut(this,'<?php echo $fondo1; ?>')" class='menu_head1'><img class="icono" src='../images/04Comunicaciones.png' /><?php echo $desplazamientoCorto . $textos['a03']; ?></p>
                                        <div class='menu_body2'>
                                            <a onmouseover="menuOver(this)" onmouseout="menuOut(this,'<?php echo $fondo2; ?>')" href='<?php echo urlNavegacion($ficheros['a0301'],$listFicherosMovil,$navegacion); ?>'><?php echo $desplazamiento . $textos['a0301']; ?></a>
                                            <a onmouseover="menuOver(this)" onmouseout="menuOut(this,'<?php echo $fondo2; ?>')" href='<?php echo urlNavegacion($ficheros['a0302'],$listFicherosMovil,$navegacion); ?>'><?php echo $desplazamiento . $textos['a0302']; ?></a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                        ...
                        <table border="0" width="600"> 
                            <tr>
                                ...
                                <td width="80" bordercolor="#FFFFFF">
                                    <div align="center"> 
                                        <a href="../index.php"><img src="../images/Salir_juan.png" align="right" border="0" alt="Cerrar Sesión Usuario"></a></p>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <script>
                                        function OnOffCambioMenu(){
                                            window.location.href='../<?php echo $_SESSION['navegacion'];?>/default2.php';
                                        }
                                    </script>
                                    <div onclick="OnOffCambioMenu();" style="cursor: pointer; width: 150px;" align="center">
                                        <br/>
                                        <font class="btn_general">Volver Principal</font>
                                    </div>
                                    <br/>
                                </td>
                            </tr>
                            <tr> 
                                <td valign="top" colspan="4" height="300" bordercolor="#FFFFFF">
                                    <hr>

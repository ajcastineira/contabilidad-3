...
logger('info','presentar_autonomo130.php-' ,"Usuario: ".$_SESSION['strUsuario'].', Empresa: '.$_SESSION['mapeo'].', SesionID: '.  session_id().
       " ||||Consulta->Autonomos->Calculados||");
...
logger('traza','presentar_autonomo130.php-' ,"Usuario: ".$_SESSION['strUsuario'].', Empresa: '.$_SESSION['mapeo'].', SesionID: '.  session_id().
       " clsCNContabilidad->calculoDatosIVA($lngEjercicio)>");

$datosPresentar=$clsCNContabilidad->CalculoDatosAutonomo130($lngEjercicio);
...
if(isset($_GET['Cierre']) && $_GET['Cierre']=='Cierre1T'){
    ...
    echo '<META HTTP-EQUIV=Refresh CONTENT="0; URL=../vista/autonomo_130.php?Ejercicio='.$lngEjercicio.'&Trimestre=1">';
    
}else if(isset($_GET['Cierre']) && $_GET['Cierre']=='Cierre2T'){

    echo '<META HTTP-EQUIV=Refresh CONTENT="0; URL=../vista/autonomo_130.php?Ejercicio='.$lngEjercicio.'&Trimestre=2">';
    
}else if(isset($_GET['Cierre']) && $_GET['Cierre']=='Cierre3T'){
    
    echo '<META HTTP-EQUIV=Refresh CONTENT="0; URL=../vista/autonomo_130.php?Ejercicio='.$lngEjercicio.'&Trimestre=3">';
    
}else if(isset($_GET['Cierre']) && $_GET['Cierre']=='Cierre4T'){
    
    echo '<META HTTP-EQUIV=Refresh CONTENT="0; URL=../vista/autonomo_130.php?Ejercicio='.$lngEjercicio.'&Trimestre=4">';
...
<html>
    <head>
        ...
        <title>Consulta Pagos a Cuenta</title>
...
<table align="center" border="0" width="701">
    <tr>
        <td>
            <h3 align="center" color="#FFCC66">Pagos a Cuenta</h3>

            <form name="form1" action="../vista/presentar_autonomo130.php" method="get">
...
<!--                            <th class="tablaEspacio"></th>
                    ...
                    <tbody>
                        <tr class="impares">
                            ...
                            <td><!-- Ingresos 1T --><table class="tablaPresentacionCasilla"><tr><td><?php echo $datosPresentar['1T']['Ingresos'];?></td></tr></table></td>
                            <td><!-- Ingresos 2T --><table class="tablaPresentacionCasilla"><tr><td><?php echo $datosPresentar['2T']['Ingresos'];?></td></tr></table></td>
                            <td><!-- Ingresos 3T --><table class="tablaPresentacionCasilla"><tr><td><?php echo $datosPresentar['3T']['Ingresos'];?></td></tr></table></td>
                            <td><!-- Ingresos 4T --><table class="tablaPresentacionCasilla"><tr><td><?php echo $datosPresentar['4T']['Ingresos'];?></td></tr></table></td>
                        </tr>
                        <tr class="pares">
                            <td><strong>Gastos</strong></td>
                            <td><!-- Gastos 1T --><table class="tablaPresentacionCasilla"><tr><td><?php echo $datosPresentar['1T']['Gastos'];?></td></tr></table></td>
                            <td><!-- Gastos 2T --><table class="tablaPresentacionCasilla"><tr><td><?php echo $datosPresentar['2T']['Gastos'];?></td></tr></table></td>
                            <td><!-- Gastos 3T --><table class="tablaPresentacionCasilla"><tr><td><?php echo $datosPresentar['3T']['Gastos'];?></td></tr></table></td>
                            <td><!-- Gastos 4T --><table class="tablaPresentacionCasilla"><tr><td><?php echo $datosPresentar['4T']['Gastos'];?></td></tr></table></td>
                        </tr>
                        <tr class="impares">
                            <td><strong>Resultado</strong></td>
                            <td><!-- Resultado 1T --><table class="tablaPresentacionCasilla"><tr><td><?php echo $datosPresentar['1T']['Resultado'];?></td></tr></table></td>
                            <td><!-- Resultado 2T --><table class="tablaPresentacionCasilla"><tr><td><?php echo $datosPresentar['2T']['Resultado'];?></td></tr></table></td>
                            <td><!-- Resultado 3T --><table class="tablaPresentacionCasilla"><tr><td><?php echo $datosPresentar['3T']['Resultado'];?></td></tr></table></td>
                            <td><!-- Resultado 4T --><table class="tablaPresentacionCasilla"><tr><td><?php echo $datosPresentar['4T']['Resultado'];?></td></tr></table></td>
                        </tr>
                        <tr class="pares">
                            <td><strong>Cuota</strong></td>
                            <td><!-- Cuota 1T --><table class="tablaPresentacionCasilla"><tr><td><?php echo $datosPresentar['1T']['Cuota'];?></td></tr></table></td>
                            <td><!-- Cuota 2T --><table class="tablaPresentacionCasilla"><tr><td><?php echo $datosPresentar['2T']['Cuota'];?></td></tr></table></td>
                            <td><!-- Cuota 3T --><table class="tablaPresentacionCasilla"><tr><td><?php echo $datosPresentar['3T']['Cuota'];?></td></tr></table></td>
                            <td><!-- Cuota 4T --><table class="tablaPresentacionCasilla"><tr><td><?php echo $datosPresentar['4T']['Cuota'];?></td></tr></table></td>
                        </tr>
                        <tr class="impares">
                            <td><strong>Cuotas<br/>Anteriores</strong></td>
                            <td><!-- CuotasAnt 1T --><table class="tablaPresentacionCasilla"><tr><td><?php echo $datosPresentar['1T']['CuotasAnt'];?></td></tr></table></td>
                            <td><!-- CuotasAnt 2T --><table class="tablaPresentacionCasilla"><tr><td><?php echo $datosPresentar['2T']['CuotasAnt'];?></td></tr></table></td>
                            <td><!-- CuotasAnt 3T --><table class="tablaPresentacionCasilla"><tr><td><?php echo $datosPresentar['3T']['CuotasAnt'];?></td></tr></table></td>
                            <td><!-- CuotasAnt 4T --><table class="tablaPresentacionCasilla"><tr><td><?php echo $datosPresentar['4T']['CuotasAnt'];?></td></tr></table></td>
                        </tr>
                        <tr class="pares">
                            <td><strong>Liquidación</strong></td>
                            <td><!-- Liquidación 1T --><table class="tablaPresentacionCasilla"><tr><td><strong><?php echo $datosPresentar['1T']['Liquidacion'];?></strong></td></tr></table></td>
                            <td><!-- Liquidación 2T --><table class="tablaPresentacionCasilla"><tr><td><strong><?php echo $datosPresentar['2T']['Liquidacion'];?></strong></td></tr></table></td>
                            <td><!-- Liquidación 3T --><table class="tablaPresentacionCasilla"><tr><td><strong><?php echo $datosPresentar['3T']['Liquidacion'];?></strong></td></tr></table></td>
                            <td><!-- Liquidación 4T --><table class="tablaPresentacionCasilla"><tr><td><strong><?php echo $datosPresentar['4T']['Liquidacion'];?></strong></td></tr></table></td>
                        </tr>
                        ...
                        ?>
                        <tr bgcolor="#FFFFFF">
                            <form name="form" action="../vista/autonomo_130.php" method="get">
                            <td></td>
                                ...
                                if($datosPresentar['1T']['Esta_Cerrado']=='NO'){
                                    ...
                                    if($trimestreEnFecha=='ACTUAL'){
                                        ...
                                        if($datosPresentar['0T']['Esta_Cerrado']=='SI'){
                                            $datosAut130=  serialize($datosPresentar['1T']);
                                            $datosAut130 = urlencode($datosAut130); 
                                            ?>
                                            <input type="hidden" name="lngEjercicio" value="<?php echo $lngEjercicio;?>" />
                                            <input type="hidden" name="datosAut130" value="<?php echo $datosAut130;?>" />
                                ...
                                if($datosPresentar['2T']['Esta_Cerrado']=='NO'){
                                    ...
                                    if($trimestreEnFecha=='ACTUAL'){
                                        ...
                                        if($datosPresentar['1T']['Esta_Cerrado']=='SI'){
                                            $datosAut130=  serialize($datosPresentar['2T']);
                                            $datosAut130 = urlencode($datosAut130); 
                                            ?>
                                            <input type="hidden" name="lngEjercicio" value="<?php echo $lngEjercicio;?>" />
                                            <input type="hidden" name="datosAut130" value="<?php echo $datosAut130;?>" />
                                ...
                                if($datosPresentar['3T']['Esta_Cerrado']=='NO'){
                                    ...
                                    if($trimestreEnFecha=='ACTUAL'){
                                        ...
                                        if($datosPresentar['2T']['Esta_Cerrado']=='SI'){
                                            $datosAut130=  serialize($datosPresentar['3T']);
                                            $datosAut130 = urlencode($datosAut130); 
                                            ?>
                                            <input type="hidden" name="lngEjercicio" value="<?php echo $lngEjercicio;?>" />
                                            <input type="hidden" name="datosAut130" value="<?php echo $datosAut130;?>" />
                                ...
                                if($datosPresentar['4T']['Esta_Cerrado']=='NO'){
                                    ...
                                    if($trimestreEnFecha=='ACTUAL'){
                                        ...
                                        if($datosPresentar['3T']['Esta_Cerrado']=='SI'){
                                            $datosAut130=  serialize($datosPresentar['4T']);
                                            $datosAut130 = urlencode($datosAut130); 
                                            ?>
                                            <input type="hidden" name="lngEjercicio" value="<?php echo $lngEjercicio;?>" />
                                            <input type="hidden" name="datosAut130" value="<?php echo $datosAut130;?>" />

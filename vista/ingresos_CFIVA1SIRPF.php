...
//se viende de dar a aceptar a editar un asiento
    ...
    if($OK<>1){
        ...
        $OK2 = $clsCNContabilidad->AltaIngresosMovimientos($_POST['Asiento'],$_SESSION["idEmp"],$_POST['strCuenta'], $_POST["lngIngreso"],
                                            $_POST['strCuentaCli'], $_POST["lngCantidad"],$_POST["lngIva"],$_POST["lngPorcientoSin"], $_POST["datFecha"],$_POST['optTipo'],
                                            $_POST['strCuentaBancos'],$_POST["lngPeriodo"], $_POST["lngEjercicio"], addslashes($_POST["strConcepto"]), $_POST['esAbono'], $_SESSION["strUsuario"]);   
...
?>
  <div class="doc"> 
    <hr color = "#FF9900">
    <br/>
    <form name="form1" method="post" action="../vista/ingresos_CFIVA1SIRPF.php">
...
function asientoCerrado(){
    ...
    <div data-role="content" data-theme="a">
        <form action="../vista/ingresos_CFIVA1SIRPF.php" name="form1" method="POST" data-ajax="false">

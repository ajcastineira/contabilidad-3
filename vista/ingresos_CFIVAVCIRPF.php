...
if(isset($_POST['cmdAlta']) && $_POST['cmdAlta']=='Alta'){ 
    ...
    if($NIFCIF==false){
        ...
        //print_r($_POST);die;
        $varRes = $clsCNContabilidad->AltaIngresosMovimientosIVA_VariosIRPF(0,$_SESSION["idEmp"],$_POST['strCuenta'], $_POST["Total"],
...
//        echo '<META HTTP-EQUIV=Refresh CONTENT="0; URL=../vista/ingresos_exito.php?op=CFIVAVCIRPF&datos='.$compactada.'&esAbono='.$_POST["esAbono"].'">';
...
//se viende de dar a aceptar a editar un asiento
    ...
    if($OK<>1){
        ...
        $OK2 = $clsCNContabilidad->AltaIngresosMovimientosIVA_VariosIRPF($_POST['Asiento'],$_SESSION["idEmp"],$_POST['strCuenta'], $_POST["Total"],
                                                $_POST['strCuentaCli'], $_POST["lngCantidadTotal"],$_POST["lngIvaTotal"], $_POST["datFecha"],$_POST['optTipo'],
                                                $_POST['strCuentaBancos'],$_POST["lngPeriodo"], $_POST["lngEjercicio"], addslashes($_POST["strConcepto"]), $_SESSION["strUsuario"],
                                                $_POST['lngCantidad1'],$_POST['lngIva1'],$_POST['lngPorciento1'],
                                                $_POST['lngCantidad2'],$_POST['lngIva2'],$_POST['lngPorciento2'],
...
?>
  <div class="doc"> 
    <hr color = "#FF9900">
    <br/>
    <form name="form1" method="post" action="../vista/ingresos_CFIVAVCIRPF.php">
        ...
        <tr>
          ...
          <td colspan="2">
              ...
              <input class="textbox1" type="text" name="lngTotalContabilidad" maxlength="10"
                     ...
                     readonly
                      />
              <input type="hidden" name="lngTotal" value="<?php if(isset($datos)){echo $datos['Total'];}else{echo '0.00';} ?>"/>
              </div>
          </td>
        </tr>
        <tr>
...
function asientoCerrado(){
    ...
    <div data-role="content" data-theme="a">
        <form action="../vista/ingresos_CFIVAVCIRPF.php" name="form1" method="POST" data-ajax="false">

...
<?php
$tituloForm='MOVIMIENTOS<br/>DE ASIENTO';
if(isset($_GET['Asiento'])){
...
?>
  <div class="apaisado"> 
    <hr color = "#FF9900">
    <br/>
    <form name="form1" method="post" action="../vista/ingresos_gastos_ver.php">

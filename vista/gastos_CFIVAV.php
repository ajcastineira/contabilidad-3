...
//        echo '<META HTTP-EQUIV=Refresh CONTENT="0; URL=../vista/gastos_exito.php?op=CFIVAV&datos='.$compactada.'&esAbono='.$_POST["esAbono"].'">';
        echo '<META HTTP-EQUIV=Refresh CONTENT="0; URL=../vista/gastos_exito.php?op=CFIVAV&tipo='.$_POST['tipo'].'">';
        }
    }
...
//se viende de dar a aceptar a editar un asiento
    ...
    if($OK<>1){
        ...
        $OK2 = $clsCNContabilidad->AltaGastosMovimientosIVA_Varios($_POST['Asiento'],$_SESSION["idEmp"],$_POST['strCuenta'], $_POST["Total"],
                                                $_POST['strCuentaCli'], $_POST["lngCantidadTotal"],$_POST["lngIvaTotal"], $_POST["datFecha"],$_POST['optTipo'],
                                                $_POST['strCuentaBancos'],$_POST["lngPeriodo"], $_POST["lngEjercicio"], addslashes($_POST["strConcepto"]), $_SESSION["strUsuario"],
                                                $_POST['lngCantidad1'],$_POST['lngIva1'],$_POST['lngPorciento1'],
                                                $_POST['lngCantidad2'],$_POST['lngIva2'],$_POST['lngPorciento2'],
...
?>
  <div class="doc"> 
    <hr color = "#FF9900">
    <br/>
    <form name="form1" method="post" action="../vista/gastos_CFIVAV.php">
...
<div data-role="page" id="gastos_CFIVAV">
<?php
eventosInputText();
?>
<script language="JavaScript">
...
function asientoCerrado(){
    ...
    <div data-role="content" data-theme="a">
        <form action="../vista/gastos_CFIVAV.php" name="form1" method="POST" data-ajax="false">

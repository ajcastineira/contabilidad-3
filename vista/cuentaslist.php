...
<form name="form1" action="../vista/cuentaslist.php" method="get">
    ...
    <tr> 
      ...
      <td width="70">
          <div align="right"><input class="textbox1" style="width:100%" type="text" name="strNombre" maxlength="50"
    ...
    <tr> 
      <td class="nombreCampo"> <div align="right">Numero de Cuenta:</div></td>
      <td>
          <div align="right"><input class="textbox1" type="text" name="lngNumCuenta" maxlength="99" onkeypress="javascript:return solonumeros(event);"
                             onMouseOver="onMouseOverInputText(this);" onMouseOut="onMouseOutInputText(this);"  onfocus="onFocusInputText(this);" onblur="onBlurInputText(this);"/>
          </div>
      </td>
    </tr>
                ...
                <tbody>
                    ...
                    if(is_array($arResult)){
                        for ($i = 0; $i < count($arResult); $i++) {
                            //print_r($arDoc);
                            $link="javascript:document.location.href='../vista/consultacuentas.php?IdCuenta=".$arResult[$i]['IdCuenta']."';";
                            ?>
                            <tr>
                                <td onClick="<?php echo $link; ?>"><?php echo $arResult[$i]['NumCuenta']; ?></td>
                                <td onClick="<?php echo $link; ?>"><?php echo $arResult[$i]['Nombre']; ?></td>
                                <td align="center"><?php echo '<a href="../vista/consultacuentas.php?IdCuenta=' . $arResult[$i]['IdCuenta'] . '&borrar=si"><img src="../images/error.png" width="10" height="10" border="0"/></a>'; ?></td>
                            </tr>
                            <?php
                        }
                    }

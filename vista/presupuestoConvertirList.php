...
<html>
    <head>
        ...
        <title>Convertir a Pedido</title>
...
function actualizarEstadoPresupuesto(IdPresupuesto,contacto_cliente,opcion){
    ...
    if((opcion==='Aceptado') &&(contacto_cliente==='CL')){
        var parcial='<a id="parcial'+IdPresupuesto+'" href="../vista/convertir_presup_parcial.php?IdPresupuesto='+IdPresupuesto+'"><img src="../images/editcut.png" width="12" height="11" border="0"/></a>';
        $('#tdparcial'+IdPresupuesto).append(parcial);
        var total='<a id="total'+IdPresupuesto+'" href="../vista/convertir_presup_total.php?IdPresupuesto='+IdPresupuesto+'"><img src="../images/folder_green.png" width="10" height="10" border="0"/></a>'; 
...
function esContacto(IdPresupuesto){
    ...
    alert('Va a visualizar el presupuesto en modo consulta. Para poder convertirlo en pedido, debe convertir el contacto en cliente.');
    document.location.href='../vista/convertir_presup_parcial.php?IdPresupuesto='+IdPresupuesto;
}
...
function irDiferencia(IdPresupuesto){
    //vamos al pedido diferencia
    alert('Este presupuesto tiene emitidos pedidos y/o facturas. Se presentará el pedido restante sobre el presupuesto.');
    document.location.href='../vista/convertir_presup_diferencia.php?IdPresupuesto='+IdPresupuesto;
}
    </script>
<?php
...
<h3 align="center" color="#FFCC66"><font size="3px">Generar Pedido</font></h3> 
<form name="form1" action="../vista/presupuestoConvertirList.php" method="get">
                                ...
                                if($contacto[0]<>'CO'){
                                    if($arResult[$i]['Estado']==='Aceptado'){
                                        if($arResult[$i]['GenFacPed']==='NO' & $arResult[$i]['GenPedPre']==='NO'){
                                            //genera un pedido dedes cero
                                            $link="javascript:document.location.href='../vista/convertir_presup_parcial.php?IdPresupuesto=".$arResult[$i]['IdPresupuesto']."';";
                                        }else{
                                            //existe ya pedidos parciales emitidos anteriormente, generamos un pedido diferencia de los anteriores
                                ...
                                <tr>
                                    ...
                                    <td id="tdparcial<?php echo $arResult[$i]['IdPresupuesto']; ?>" align="center">
                                        ...
                                        if(($contacto[0]<>'CO') && ($arResult[$i]['Estado']==='Aceptado')){
                                            if($arResult[$i]['GenFacPed']==='NO' && $arResult[$i]['GenPedPre']==='NO'){
                                                echo '<a id="parcial'.$arResult[$i]['IdPresupuesto'].'" href="../vista/convertir_presup_parcial.php?IdPresupuesto='.$arResult[$i]['IdPresupuesto'] . '"><img src="../images/editcut.png" width="12" height="11" border="0"/></a>';
                                            }
                                        }
                                        ?>
                                    </td>
                                    <td id="tdtotal<?php echo $arResult[$i]['IdPresupuesto']; ?>" align="center">
                                        ...
                                        if(($contacto[0]<>'CO') && ($arResult[$i]['Estado']==='Aceptado')){
                                            if($arResult[$i]['GenFacPed']==='NO' && $arResult[$i]['GenPedPre']==='NO'){
                                                echo '<a id="total'.$arResult[$i]['IdPresupuesto'].'" href="../vista/convertir_presup_total.php?IdPresupuesto='.$arResult[$i]['IdPresupuesto'] . '"><img src="../images/folder_green.png" width="10" height="10" border="0"/></a>'; 
                                            }
                                        }
                                        ?>
                                    </td>

  ...
  <div class="apaisado"> 
    ...
    <form name="form1" method="post" action="../vista/ingresos_gastos.php">
                          ...
                          <div align="left">
                            ...
                            ?>
                              <input class="textbox1" size="40" type="text" id="strCuentaDEBE<?php echo $i;?>" name="strCuentaDEBE<?php echo $i;?>" onKeyUp="comprobarCuenta(this,document.getElementById('okStrCuentaDEBE<?php echo $i;?>'));"
                                   ...
                                   onblur="onBlurInputText(this);onBlurInputText(document.getElementById('strConceptoDEBE<?php echo $i;?>'));onBlurInputText(document.getElementById('lngCuentaDEBE[<?php echo $i;?>]'));comprobarCuentaBlur(this,document.getElementById('okStrCuentaDEBE<?php echo $i;?>'));"
                        ...
                        <td>
                          <div align="left">
                            ...
                            <input class="textbox1" size="40" type="text" id="strCuentaHABER<?php echo $i;?>" name="strCuentaHABER<?php echo $i;?>" onKeyUp="comprobarCuenta(this,document.getElementById('okStrCuentaHABER<?php echo $i;?>'));" 
                                   ...
                                   onblur="onBlurInputText(this);onBlurInputText(document.getElementById('strConceptoHABER<?php echo $i;?>'));onBlurInputText(document.getElementById('lngCuentaHABER[<?php echo $i;?>]'));comprobarCuentaBlur(this,document.getElementById('okStrCuentaHABER<?php echo $i;?>'));"
      ...
      <P>
        ...
        <?php }?>
        />
        <input type="button" name="cmdAlta" id="cmdAlta" value = "Aceptar" onclick="javascript:validar2();" 
        <?php if($editar=='NO'){?>
            disabled="true"
            class="buttonDesactivado" disabled="true"
        <?php }else{?>
        ...
        /> 
        <?php if(isset($_GET['Asiento'])){?>
            <input type="button" class="button"  value="Borrar" name="cmdBorrar" onclick="javascript:borrarAsiento('<?php echo $Asiento;?>');" />
        <?php }?>

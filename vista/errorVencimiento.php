    ...
    <td bgcolor="#FFFFFF" align ="center" valign="top">
	  <br><br>
	   <h3 align="center"><font color="#FF0000">¡¡SE HA PRODUCIDO UN ERROR!!</font></h3>
	    ...
	    <p>
            <?php
            echo 'Ha pasado la fecha de vencimiento de la aplicacion.<br>Contacte con Qualidad para su renovación';
            ?>
	   </p>
	   <br><br>
          <div align="center"><a href="../index.php"><IMG height=67 alt="Ir al menú" src="../images/logo-Qualidad.JPG" width=132 border="0"></a></div></td> 
     </td> 
  </tr>

...
//  ConFactura+IVA1+ConRetencionIRPF 
//
//
//Caso 2 (ConFactura+IVA1+ConRetencionIRPF)
if(isset($_POST['cmdAlta']) && $_POST['cmdAlta']=='Alta'){
    logger('info',basename($_SERVER['PHP_SELF']).'-' ,"Usuario: ".$_SESSION['strUsuario'].', Empresa: '.$_SESSION['strBD'].', SesionID: '.  session_id().
           " ||||Operaciones->Mis Ingresos|| Ha pulsado 'Aceptar'(ConFactura+IVA1+ConRetencionIRPF)");

    //print_r($_POST);die;
    //guardo el ingreso el la tabla tbmovimientos, tbacumulados y tbmovimientos_iva
    $varRes = $clsCNContabilidad->AltaIngresosMovimientosIRPF(0,$_SESSION["idEmp"],$_POST['strCuenta'],$_POST['strCuentaCli'],
                                            $_POST["lngCantidad1"],$_POST["lngIva1"],$_POST["lngPorciento1"],
                                            $_POST["lngIRPF"],$_POST["lngPorcientoIRPF"],$_POST["datFecha"],
                                            $_POST['optTipo'],$_POST['strCuentaBancos'],$_POST["lngPeriodo"],$_POST["strPeriodo"],
                                            $_POST["lngEjercicio"], addslashes($_POST["strConcepto"]), $_POST['esAbono'], $_SESSION["strUsuario"]);   
    
    logger('warning','' ,
           ' $clsCNContabilidad->AltaIngresosMovimientosIRPF(0,'.$_SESSION["idEmp"].",'".$_POST['strCuenta']."','".$_POST['strCuentaCli']."','".
                                            $_POST["lngCantidad1"]."','".$_POST["lngIva1"]."','".$_POST["lngPorciento1"]."','".
                                            $_POST["lngIRPF"]."','".$_POST["lngPorcientoIRPF"]."','".$_POST["datFecha"]."','".
                                            $_POST['optTipo']."','".$_POST['strCuentaBancos']."','".$_POST["lngPeriodo"]."','".$_POST["strPeriodo"]."','".
                                            $_POST["lngEjercicio"]."','". addslashes($_POST["strConcepto"])."','". $_POST['esAbono']."','". $_SESSION["strUsuario"]."');");
...
//            "lngTotalContabilidad"=>$_POST["lngTotalContabilidad"],
...
//            "lngIRPF"=>$_POST["lngIRPF"],
//            "lngIRPFContabilidad"=>$_POST["lngIRPFContabilidad"],
//            "lngPorcientoIRPF"=>$_POST["lngPorcientoIRPF"],
...
//        echo '<META HTTP-EQUIV=Refresh CONTENT="0; URL=../vista/ingresos_exito.php?op=CFIVA1CIRPF&datos='.$compactada.'&esAbono='.$_POST["esAbono"].'">';
        echo '<META HTTP-EQUIV=Refresh CONTENT="0; URL=../vista/gastos_exito.php?op=CFIVA1CIRPF">';
    }
...
//se viene del listado de editar asientos (listado_asientos2.php)
    ...
    $datos=$clsCNContabilidad->DatosAsientoCFIVA1CIRPF($_GET['Asiento'],$_GET['esAbono']);
...
//se viende de dar a aceptar a editar un asiento
    ...
    if($OK<>1){
        ...
        $OK2 = $clsCNContabilidad->AltaIngresosMovimientosIRPF($_POST['Asiento'],$_SESSION["idEmp"],$_POST['strCuenta'],$_POST['strCuentaCli'],
                                            $_POST["lngCantidad1"],$_POST["lngIva1"],$_POST["lngPorciento1"],
                                            $_POST["lngIRPF"],$_POST["lngPorcientoIRPF"],$_POST["datFecha"],
                                            $_POST['optTipo'],$_POST['strCuentaBancos'],$_POST["lngPeriodo"],$_POST["strPeriodo"],
                                            $_POST["lngEjercicio"], addslashes($_POST["strConcepto"]), $_POST['esAbono'], $_SESSION["strUsuario"]);   
...
function validar()
{
  ...
  if(document.form1.optTipo[1].checked===true){
    ...
    if (document.form1.lngCantidadContabilidad1.value === '0,00' ||
        document.form1.lngCantidadContabilidad1.value === ''){ 
      ...
      document.form1.lngCantidadContabilidad1.title ='El valor de la factura debe ser superior a 0';
      esValido=false;
    }
...
function formateoColoresCampo(esAbono){
    if(esAbono==='SI'){
        ...
        formateoCampoColor(document.form1.lngIRPFContabilidad,'<?php echo $_GET['esAbono'];?>','#FF0000');
        formateoCampoColor(document.form1.lngTotalContabilidad,'<?php echo $_GET['esAbono'];?>','#FF0000');
    }else{
        ...
        formateoCampoColor(document.form1.lngIRPFContabilidad,'<?php echo $_GET['esAbono'];?>','#666666');
        formateoCampoColor(document.form1.lngTotalContabilidad,'<?php echo $_GET['esAbono'];?>','#666666');
    }    
}
...
?>
  <div class="doc"> 
    <hr color = "#FF9900">
    <br/>
    <form name="form1" method="post" action="../vista/ingresos_CFIVA1CIRPF.php">
      ...
      <table width="640" border="0" class="zonaactiva">
        ...
        <tr> 
          ...
          <td colspan="2">
            ...
            <input class="textbox1" type="text" id="datFecha" name="datFecha" maxlength="38" tabindex="1" 
        ...
        <tr>
          <td colspan="2">
              ...
              <input class="textbox1" type="text" name="lngCantidadContabilidad1" maxlength="10" id="lngCantidadContabilidad1"
                     value="<?php if(isset($datos)){echo $datos['lngCantidadContabilidad1'];}else{echo '0,00';} ?>" tabindex="5"
                     <?php if($editarAsiento==='SI') {?>
          ...
          <td colspan="3">
              ...
              <select name="lngPorciento1"
                   ...
                   <?php if($editarAsiento==='SI') {?>
                      onchange="CalculaIva1(document.form1.lngCantidad1.value,this.value);
                                CalculaIRPF(document.form1.lngCantidad1.value,document.form1.lngPorcientoIRPF.value);TotalIRPF();
                                formateaNegativoContabilidad(document.form1.lngIvaContabilidad1,'<?php echo $_GET['esAbono'];?>');
                                formateaNegativoContabilidad(document.form1.lngIRPFContabilidad,'<?php echo $_GET['esAbono'];?>');
                                formateaNegativoContabilidad(document.form1.lngTotalContabilidad,'<?php echo $_GET['esAbono'];?>');"
                      onMouseOver="onMouseOverInputText(this);" onMouseOut="onMouseOutInputText(this);" tabindex="6" 
                   <?php }else{?>
                      disabled="true"
                   <?php }?>
                   >
          ...
          <td colspan="2">
              ...
              <input class="textbox1" type="text" name="lngIvaContabilidad1" maxlength="4" readonly
                     style="text-align:right;font-weight:bold;" value="<?php if(isset($datos)){echo $datos['lngIvaContabilidad1'];}else{echo '0,00';} ?>"
                     onMouseOver="onMouseOverInputText(this);" onMouseOut="onMouseOutInputText(this);"/>
        ...
        <tr>
          ...
          <td colspan="3">
              ...
              <select name="lngPorcientoIRPF"
                      class="textbox1" style="text-align:right;font-weight:bold;width:50%;" tabindex="7"
                   <?php if($editarAsiento==='SI') {?>
                      onchange="CalculaIva1(document.form1.lngCantidad1.value,document.form1.lngPorciento1.value);
                                CalculaIRPF(document.form1.lngCantidad1.value,this.value);TotalIRPF();
                                formateaNegativoContabilidad(document.form1.lngIvaContabilidad1,'<?php echo $_GET['esAbono'];?>');
                                formateaNegativoContabilidad(document.form1.lngIRPFContabilidad,'<?php echo $_GET['esAbono'];?>');
                                formateaNegativoContabilidad(document.form1.lngTotalContabilidad,'<?php echo $_GET['esAbono'];?>');"
                      onMouseOver="onMouseOverInputText(this);" onMouseOut="onMouseOutInputText(this);"
          ...
          <td colspan="2">
              ...
              <input type="hidden" name="lngIRPF" value="<?php echo $datos['lngIRPF'];?>"/>
              </div>
          </td>
          <td></td>
          <td colspan="2">
              ...
              <input class="textbox1" type="text" name="lngTotalContabilidad" maxlength="10" tabindex="8"
                     style="text-align:right;font-weight:bold;" onkeypress="return solonumeros(event);"
                     value="<?php if(isset($datos)){echo $datos['lngTotalContabilidad'];}else{echo '0,00';} ?>"
                     <?php if($editarAsiento==='SI') {?>
                     onfocus="entradaCantidad(this,document.form1.lngIngreso);selecciona_value(this);"
                     onkeyUp="CalculaDesdeTotal(this.value,document.form1.lngPorciento1.value,document.form1.lngPorcientoIRPF.value);"
                     onblur="CalculaDesdeTotal(this.value,document.form1.lngPorciento1.value,document.form1.lngPorcientoIRPF.value);formateaCantidad(this);
                             formateaNegativoContabilidad(document.form1.lngCantidadContabilidad1,'<?php echo $_GET['esAbono'];?>');
                             formateaNegativoContabilidad(document.form1.lngIvaContabilidad1,'<?php echo $_GET['esAbono'];?>');
                             formateaNegativoContabilidad(document.form1.lngIRPFContabilidad,'<?php echo $_GET['esAbono'];?>');
                             formateaNegativoContabilidad(this,'<?php echo $_GET['esAbono'];?>');"
                     onMouseOver="onMouseOverInputText(this);" onMouseOut="onMouseOutInputText(this);"
        ...
        <tr>
            ...
            <td>
                ...
                <input class="txtgeneral" type="radio" name="optTipo" value="0" 
                     <?php if(!(isset($datos['optTipo'])) || $datos['optTipo']=='0'){echo 'checked';} ?> onClick="ActivaSelecBanco(this);" tabindex="9"
                     <?php if($editarAsiento<>'SI') {?>
                     disabled="true"
                     <?php }?>
                     />
        ...
        <tr>
            ...
            <td>
                ...
                <input class="txtgeneral" type="radio" name="optTipo" value="1" 
                     <?php if($datos['optTipo']=='1'){echo 'checked';} ?> onClick="ActivaSelecBanco(this);" tabindex="10"
                     <?php if($editarAsiento<>'SI') {?>
                     disabled="true"
                     <?php }?>
                     />
            ...
            <td colspan="6"> 
                ...
                <input class="textbox1" type="text" id="strCuentaBancos" name="strCuentaBancos" <?php if(!(isset($datos['optTipo'])) || $datos['optTipo']=='0'){echo 'disabled';} ?>
                   ...
                   onMouseOver="onMouseOverInputText(this);" onMouseOut="onMouseOutInputText(this);" tabindex="11"
      ...
      <P>
        ...
        <input type="button" class="button" name="cmdAlta" id="cmdAlta" value = "Grabar" onclick="javascript:validar();" tabindex="12" /> 
...
<div data-role="page" id="ingresos_CFIVA1CIRPF">
<?php
eventosInputText();
?>
<script language="JavaScript">
...
function asientoCerrado(){
    ...
    <div data-role="content" data-theme="a">
        <form action="../vista/ingresos_CFIVA1CIRPF.php" name="form1" method="POST" data-ajax="false">
                ...
                <tbody>
                      ...
                      <td colspan="2">
                          <div align="left">
                            <label>% IVA Aplicable</label>
                                <select name="lngPorciento1" style="text-align:right;font-weight:bold;width:50%;"
                                     <?php if($editarAsiento==='SI') {?>
                                        onchange="CalculaIva1(document.form1.lngCantidad1.value,this.value);
                                                  CalculaIRPF(document.form1.lngCantidad1.value,document.form1.lngPorcientoIRPF.value);TotalIRPF();
                                                  formateaNegativoContabilidad(document.form1.lngIvaContabilidad1,'<?php echo $_GET['esAbono'];?>');
                      ...
                      <td colspan="2">
                          <div align="left">
                            ...
                            <input type="text" name="lngIvaContabilidad1" maxlength="4" readonly
                                   style="text-align:right;font-weight:bold;" value="<?php if(isset($datos['lngIvaContabilidad1'])){echo $datos['lngIvaContabilidad1'];}else{echo '0,00';} ?>"
                                   />
                            <input type="hidden" name="lngIva1" value="<?php echo $datos['lngIva1'];?>"/>
                          </div>
                      </td>
                    ...
                    <tr>
                      <td colspan="2">
                          <div align="left">
                            <label>% IRPF</label>
                            <select name="lngPorcientoIRPF" style="text-align:right;font-weight:bold;width:50%;"
                                 <?php if($editarAsiento==='SI') {?>
                                    onchange="CalculaIva1(document.form1.lngCantidad1.value,document.form1.lngPorciento1.value);
                                              CalculaIRPF(document.form1.lngCantidad1.value,this.value);TotalIRPF();
                                              formateaNegativoContabilidad(document.form1.lngIvaContabilidad1,'<?php echo $_GET['esAbono'];?>');
                      ...
                      <td colspan="2">
                          <div align="left">
                            ...
                            <input type="text" name="lngIRPFContabilidad" maxlength="4"
                                   readonly value="<?php if(isset($datos['lngIRPFContabilidad'])){echo $datos['lngIRPFContabilidad'];}else{echo '0,00';} ?>"
                                   style="text-align:right;font-weight:bold;" />
                            <input type="hidden" name="lngIRPF" value="<?php echo $datos['lngIRPF'];?>"/>
                          </div>
                      </td>
                    ...
                    <tr>
                      <td colspan="2">
                          <div align="left">
                            ...
                            <input type="text" name="lngTotalContabilidad" maxlength="10" tabindex="8"
                                   style="text-align:right;font-weight:bold;"
                                   value="<?php if(isset($datos['lngTotalContabilidad'])){echo $datos['lngTotalContabilidad'];}else{echo '0,00';} ?>"
                                   <?php if($editarAsiento==='SI') {?>
                                   onfocus="onFocusInputTextM(this);entradaCantidad(this,document.form1.lngIngreso);selecciona_value(this);"
                                   onkeyUp="CalculaDesdeTotal(this.value,document.form1.lngPorciento1.value,document.form1.lngPorcientoIRPF.value);"
                                   onblur="solonumerosM(this);CalculaDesdeTotal(this.value,document.form1.lngPorciento1.value,document.form1.lngPorcientoIRPF.value);formateaCantidad(this);
                                           formateaNegativoContabilidad(document.form1.lngCantidadContabilidad1,'<?php echo $_GET['esAbono'];?>');
                                           formateaNegativoContabilidad(document.form1.lngIvaContabilidad1,'<?php echo $_GET['esAbono'];?>');
                                           formateaNegativoContabilidad(document.form1.lngIRPFContabilidad,'<?php echo $_GET['esAbono'];?>');
                                           formateaNegativoContabilidad(this,'<?php echo $_GET['esAbono'];?>');"
                        ...
                        <td colspan="4">
                          <div align="left" id="pantalla" style="display: none;">
                                ...
                                <input type="text" id="strCuentaBancos" name="strCuentaBancos" <?php if(!(isset($datos['optTipo'])) || $datos['optTipo']=='0'){echo '';} ?>
                                   ...
                                   onblur="comprobarCuentaBlur(this,document.getElementById('okStrCuentaBancos'));" />
                                <input type="hidden" id="okStrCuentaBancos" name="okStrCuentaBancos" value="<?php if($NoE==='nuevo'){echo 'NO';}else if($NoE==='edicion'){echo 'SI';} ?>" />
                          </div>
                        </td>
                    </tr>

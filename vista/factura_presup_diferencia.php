...
if(isset($_POST['IdPresupuesto'])){
    ...
    logger('info',basename($_SERVER['PHP_SELF']).'-' ,"Usuario: ".$_SESSION['strUsuario'].', Empresa: '.$_SESSION['strBD'].', SesionID: '.  session_id().
       " ||||Mis Presupuestos->Facturar Presupuesto|| A pulsado 'Generar Factura'");

    $IdFactura=$clsCNContabilidad->generarFacturaDePresupuesto($_SESSION['usuario'],$_POST);
    
    echo '<META HTTP-EQUIV=Refresh CONTENT="0; URL=../'.$_SESSION['navegacion'].'/altafactura.php?IdFactura='.$IdFactura.'">';die;
...
<form id="form1" name="form1" method="post" action="../vista/factura_presup_parcial.php" onSubmit="desactivaBoton();">
    ...
    <tr> 
        ...
        <td>
            ...
            <table border="0" class="cabecera">
                ...
                <tr align="right">
                    <td>Facturas y/o pedidos emitidos:</td>
    ...
    <input type="hidden" name="esValido" value="false"/>     
      ...
      <P>
        ...
        if($datosContacto[0]==='CL'){
            ...
            ?>
                <input type="button" id="generar" name="generar" value = "Generar Factura" class="button" onClick="generarFactura();" />
            <?php
            }else{
            ?>

...
if(isset($_POST['optFactura']) && $_POST['optFactura']=='SinFactura'){
    logger('info','gastos_entrada.php-' ,"Usuario: ".$_SESSION['strUsuario'].', Empresa: '.$_SESSION['mapeo'].', SesionID: '.  session_id().
           " ||||Operaciones->Mis Gastos||(Sin Factura)");
...
if(isset($_POST['optFactura']) && $_POST['optFactura']=='ConFactura' && 
   ...
   isset($_POST['optRetIRPF']) && $_POST['optRetIRPF']=='SinRetencionIRPF'){ 
    logger('info','gastos_entrada.php-' ,"Usuario: ".$_SESSION['strUsuario'].', Empresa: '.$_SESSION['mapeo'].', SesionID: '.  session_id().
           " ||||Operaciones->Mis Gastos||(Con Factura + Varios IVAs + Sin Retencion IRPF)");
    
//    echo '<META HTTP-EQUIV=Refresh CONTENT="0; URL=../vista/gastos_CFIVAV.php?esAbono='.$_POST['optAbono'].'">';
    echo '<META HTTP-EQUIV=Refresh CONTENT="0; URL=../vista/gastos_entrada2.php?pag=gastos_CFIVAV&esAbono='.$_POST['optAbono'].'">';
}else
if(isset($_POST['optFactura']) && $_POST['optFactura']=='ConFactura' && 
   isset($_POST['optTipoIVA']) && $_POST['optTipoIVA']=='IVA1' &&
   isset($_POST['optRetIRPF']) && $_POST['optRetIRPF']=='SinRetencionIRPF'){ 
    logger('info','gastos_entrada.php-' ,"Usuario: ".$_SESSION['strUsuario'].', Empresa: '.$_SESSION['mapeo'].', SesionID: '.  session_id().
           " ||||Operaciones->Mis Gastos||(Con Factura + 1 IVA + Sin Retencion IRPF)");
    
//    echo '<META HTTP-EQUIV=Refresh CONTENT="0; URL=../vista/gastos_CFIVA1SIRPF.php?esAbono='.$_POST['optAbono'].'">';
    echo '<META HTTP-EQUIV=Refresh CONTENT="0; URL=../vista/gastos_entrada2.php?pag=gastos_CFIVA1SIRPF&esAbono='.$_POST['optAbono'].'">';
}else
if(isset($_POST['optFactura']) && $_POST['optFactura']=='ConFactura' && 
   isset($_POST['optTipoIVA']) && $_POST['optTipoIVA']=='IVA1' &&
   isset($_POST['optRetIRPF']) && $_POST['optRetIRPF']=='ConRetencionIRPF'){ 
    logger('info','gastos_entrada.php-' ,"Usuario: ".$_SESSION['strUsuario'].', Empresa: '.$_SESSION['mapeo'].', SesionID: '.  session_id().
           " ||||Operaciones->Mis Gastos||(Con Factura + 1 IVA + Con Retencion IRPF)");
    
//    echo '<META HTTP-EQUIV=Refresh CONTENT="0; URL=../vista/gastos_CFIVA1CIRPF.php?esAbono='.$_POST['optAbono'].'">';
    echo '<META HTTP-EQUIV=Refresh CONTENT="0; URL=../vista/gastos_entrada2.php?pag=gastos_CFIVA1CIRPF&esAbono='.$_POST['optAbono'].'">';
}else
if(isset($_POST['optFactura']) && $_POST['optFactura']=='ConFactura' && 
   isset($_POST['optTipoIVA']) && $_POST['optTipoIVA']=='IVA_Varios' &&
   isset($_POST['optRetIRPF']) && $_POST['optRetIRPF']=='ConRetencionIRPF'){ 
    logger('info','gastos_entrada.php-' ,"Usuario: ".$_SESSION['strUsuario'].', Empresa: '.$_SESSION['mapeo'].', SesionID: '.  session_id().
           " ||||Operaciones->Mis Gastos||(Con Factura + Varios IVAs + Con Retencion IRPF)");
    
//    echo '<META HTTP-EQUIV=Refresh CONTENT="0; URL=../vista/gastos_CFIVAVCIRPF.php?esAbono='.$_POST['optAbono'].'">';
    echo '<META HTTP-EQUIV=Refresh CONTENT="0; URL=../vista/gastos_entrada2.php?pag=gastos_CFIVAVCIRPF&esAbono='.$_POST['optAbono'].'">';
}else{
logger('info','gastos_entrada.php-' ,"Usuario: ".$_SESSION['strUsuario'].', Empresa: '.$_SESSION['mapeo'].', SesionID: '.  session_id().
...
?>
  <div class="doc"> 
    <hr color = "#FF9900">
    <br/>
    <form name="form1" method="post" action="../vista/gastos_entrada1.php">
      ...
      <div id="formOpciones" style="display:block">
        ...
        <table width="640" border="0" class="zonaactiva">
          <tr> 
            <td class="subtitulo" colspan="4">&nbsp;Abono (Factura rectificativa)</td>
          </tr>
          <tr>
              <td width="15%"></td>
              <td width="40%"></td>

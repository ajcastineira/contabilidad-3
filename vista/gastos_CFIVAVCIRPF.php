...
if(isset($_POST['cmdAlta']) && $_POST['cmdAlta']=='Alta'){ 
    logger('info','gastos.php-' ,"Usuario: ".$_SESSION['strUsuario'].', Empresa: '.$_SESSION['mapeo'].', SesionID: '.  session_id().
           " ||||Operaciones->Mis Gastos|| Ha pulsado 'Aceptar'(ConFactura+IVA_Varios+SinRetencionIRPF)");
    ...
    if($NIFCIF==false){
        ...
        //print_r($_POST);die;
        $varRes = $clsCNContabilidad->AltaGastosMovimientosIVA_VariosIRPF(0,$_SESSION["idEmp"],$_POST['strCuenta'], $_POST["lngTotal"],
                                                ...
                                                $_POST['lngPorcientoIRPF'],$_POST['lngIRPF']);   

        //ACTUALIZAR COMENTARIO
        logger('warning','' ,
               ' $clsCNContabilidad->AltaGastosMovimientosIVA_Varios(0,'.$_SESSION["idEmp"].",'".$_POST['strCuenta']."','". $_POST["Total"]."','".
                                                $_POST['strCuentaCli']."','". $_POST["lngCantidadTotal"]."','".$_POST["lngIvaTotal"]."','". $_POST["datFecha"]."','".$_POST['optTipo']."','".
                                                $_POST['strCuentaBancos']."','".$_POST["lngPeriodo"]."','". $_POST["lngEjercicio"]."','". addslashes($_POST["strConcepto"])."','". $_SESSION["strUsuario"]."','".
                                                $_POST['lngCantidad1']."','".$_POST['lngIva1']."','".$_POST['lngPorciento1']."','".
                                                $_POST['lngCantidad2']."','".$_POST['lngIva2']."','".$_POST['lngPorciento2']."','".
...
//        echo '<META HTTP-EQUIV=Refresh CONTENT="0; URL=../vista/gastos_exito.php?op=CFIVAVCIRPF&datos='.$compactada.'&esAbono='.$_POST["esAbono"].'">';
        echo '<META HTTP-EQUIV=Refresh CONTENT="0; URL=../vista/gastos_exito.php?op=CFIVAVCIRPF&tipo='.$_POST['tipo'].'">';
        }
    }
...
//se viene del listado de editar asientos (listado_asientos2.php)
    ...
    logger('info','gastos_CFIVAV.php-' ,"Usuario: ".$_SESSION['strUsuario'].', Empresa: '.$_SESSION['mapeo'].', SesionID: '.  session_id().
    ...
    $datos=$clsCNContabilidad->DatosAsientoCFIVAVCIRPF($_GET['Asiento'],$_GET['esAbono']);
    
    //vemos si el asiento esta en un periodo editable para el iva
...
//        print_r($_POST);die;
        $OK2 = $clsCNContabilidad->AltaGastosMovimientosIVA_VariosIRPF($_POST['Asiento'],$_SESSION["idEmp"],$_POST['strCuenta'], $_POST["lngTotal"],
                                                $_POST['strCuentaCli'], $_POST["lngCantidadTotal"],$_POST["lngIvaTotal"], $_POST["datFecha"],$_POST['optTipo'],
                                                $_POST['strCuentaBancos'],$_POST["lngPeriodo"], $_POST["lngEjercicio"], addslashes($_POST["strConcepto"]), $_SESSION["strUsuario"],
                                                $_POST['lngCantidad1'],$_POST['lngIva1'],$_POST['lngPorciento1'],
                                                $_POST['lngCantidad2'],$_POST['lngIva2'],$_POST['lngPorciento2'],
...
?>
  <div class="doc"> 
    <hr color = "#FF9900">
    <br/>
    <form name="form1" method="post" action="../vista/gastos_CFIVAVCIRPF.php">
        ...
        <tr><!-- Esta fila se repite 4 veces: 1 -->
          <td colspan="2">
              ...
              <input class="textbox1" type="text" name="lngCantidadContabilidad1" maxlength="10" tabindex="5"
                     ...
                     onkeyUp="CalculaIva1(this.value,document.form1.lngPorciento1.value);SumasFactura2();
                              CalculaIRPF(document.form1.lngCantidadTotal.value,document.form1.lngPorcientoIRPF.value);TotalIRPF2();"
                     onblur="onBlurInputText(this);CalculaIva1(this.value,document.form1.lngPorciento1.value);SumasFactura2();
                             CalculaIRPF(document.form1.lngCantidadTotal.value,document.form1.lngPorcientoIRPF.value);TotalIRPF2();formateaCantidad(this);
          ...
          <td colspan="3">
              ...
              <select name="lngPorciento1"
                   ...
                   <?php if($editarAsiento==='SI') {?>
                      onchange="CalculaIva1(document.form1.lngCantidad1.value,this.value);SumasFactura2();
                                CalculaIRPF(document.form1.lngCantidadTotal.value,document.form1.lngPorcientoIRPF.value);TotalIRPF2();
                                formateaNegativoContabilidad(document.form1.lngIvaContabilidad1,'<?php echo $_GET['esAbono'];?>');
                                formateaNegativoContabilidad(document.form1.lngCantidadContabilidadTotal,'<?php echo $_GET['esAbono'];?>');
                                formateaNegativoContabilidad(document.form1.lngIvaContabilidadTotal,'<?php echo $_GET['esAbono'];?>');
        ...
        <tr><!-- 2 -->
          <td colspan="2">
              ...
              <input class="textbox1" type="text" name="lngCantidadContabilidad2" maxlength="10" tabindex="7"
                     ...
                     <?php if($editarAsiento==='SI') {?>
                     onkeypress="return solonumeros(event);" 
                     onkeyUp="CalculaIva2(this.value,document.form1.lngPorciento2.value);SumasFactura2();
                              CalculaIRPF(document.form1.lngCantidadTotal.value,document.form1.lngPorcientoIRPF.value);TotalIRPF2();"
                     onblur="onBlurInputText(this);CalculaIva2(this.value,document.form1.lngPorciento2.value);SumasFactura2();
                             CalculaIRPF(document.form1.lngCantidadTotal.value,document.form1.lngPorcientoIRPF.value);TotalIRPF2();formateaCantidad(this);
                             formateaNegativoContabilidad(this,'<?php echo $_GET['esAbono'];?>');
          ...
          <td colspan="3">
              ...
              <select name="lngPorciento2"
                   ...
                   <?php if($editarAsiento==='SI') {?>
                      onchange="CalculaIva2(document.form1.lngCantidad2.value,this.value);SumasFactura2();
                                CalculaIRPF(document.form1.lngCantidadTotal.value,document.form1.lngPorcientoIRPF.value);TotalIRPF2();
                                formateaNegativoContabilidad(document.form1.lngIvaContabilidad2,'<?php echo $_GET['esAbono'];?>');
                                formateaNegativoContabilidad(document.form1.lngCantidadContabilidadTotal,'<?php echo $_GET['esAbono'];?>');
                                formateaNegativoContabilidad(document.form1.lngIvaContabilidadTotal,'<?php echo $_GET['esAbono'];?>');
        ...
        <tr><!-- 3 -->
          <td colspan="2">
              ...
              <input class="textbox1" type="text" name="lngCantidadContabilidad3" maxlength="10" tabindex="9"
                     ...
                     <?php if($editarAsiento==='SI') {?>
                     onkeypress="return solonumeros(event);"  
                     onkeyUp="CalculaIva3(this.value,document.form1.lngPorciento3.value);SumasFactura2();
                              CalculaIRPF(document.form1.lngCantidadTotal.value,document.form1.lngPorcientoIRPF.value);TotalIRPF2();"
                     onblur="onBlurInputText(this);CalculaIva3(this.value,document.form1.lngPorciento3.value);SumasFactura2();
                             CalculaIRPF(document.form1.lngCantidadTotal.value,document.form1.lngPorcientoIRPF.value);TotalIRPF2();formateaCantidad(this);
                             formateaNegativoContabilidad(this,'<?php echo $_GET['esAbono'];?>');
          ...
          <td colspan="3">
              ...
              <select name="lngPorciento3"
                   ...
                   <?php if($editarAsiento==='SI') {?>
                      onchange="CalculaIva3(document.form1.lngCantidad3.value,this.value);SumasFactura2();
                                CalculaIRPF(document.form1.lngCantidadTotal.value,document.form1.lngPorcientoIRPF.value);TotalIRPF2();
                                formateaNegativoContabilidad(document.form1.lngIvaContabilidad3,'<?php echo $_GET['esAbono'];?>');
                                formateaNegativoContabilidad(document.form1.lngCantidadContabilidadTotal,'<?php echo $_GET['esAbono'];?>');
                                formateaNegativoContabilidad(document.form1.lngIRPFContabilidad,'<?php echo $_GET['esAbono'];?>');
        ...
        <tr><!-- 4 -->
          <td colspan="2">
              ...
              <input class="textbox1" type="text" name="lngCantidadContabilidad4" maxlength="10" tabindex="11"
                     ...
                     <?php if($editarAsiento==='SI') {?>
                     onkeypress="return solonumeros(event);" 
                     onkeyUp="CalculaIva4(this.value,document.form1.lngPorciento4.value);SumasFactura2();
                              CalculaIRPF(document.form1.lngCantidadTotal.value,document.form1.lngPorcientoIRPF.value);TotalIRPF2();"
                     onblur="onBlurInputText(this);CalculaIva4(this.value,document.form1.lngPorciento4.value);SumasFactura2();
                             CalculaIRPF(document.form1.lngCantidadTotal.value,document.form1.lngPorcientoIRPF.value);TotalIRPF2();formateaCantidad(this);
                             formateaNegativoContabilidad(this,'<?php echo $_GET['esAbono'];?>');
          ...
          <td colspan="3">
              ...
              <select name="lngPorciento4"
                   ...
                   <?php if($editarAsiento==='SI') {?>
                      onchange="CalculaIva4(document.form1.lngCantidad4.value,this.value);SumasFactura2();
                                CalculaIRPF(document.form1.lngCantidadTotal.value,document.form1.lngPorcientoIRPF.value);TotalIRPF2();
                                formateaNegativoContabilidad(document.form1.lngIvaContabilidad4,'<?php echo $_GET['esAbono'];?>');
                                formateaNegativoContabilidad(document.form1.lngCantidadContabilidadTotal,'<?php echo $_GET['esAbono'];?>');
                                formateaNegativoContabilidad(document.form1.lngIvaContabilidadTotal,'<?php echo $_GET['esAbono'];?>');
...
<!--              <div align="left">
        ...
        <tr>
              ...
              <select name="lngPorcientoIRPF"
                   ...
                   <?php if($editarAsiento==='SI') {?>
                      onchange="CalculaIva1(document.form1.lngCantidad1.value,document.form1.lngPorciento1.value);
                                CalculaIRPF(document.form1.lngCantidadTotal.value,this.value);TotalIRPF2();
                                formateaNegativoContabilidad(document.form1.lngIvaContabilidad1,'<?php echo $_GET['esAbono'];?>');
                                formateaNegativoContabilidad(document.form1.lngIRPFContabilidad,'<?php echo $_GET['esAbono'];?>');
                                formateaNegativoContabilidad(document.form1.lngTotalContabilidad,'<?php echo $_GET['esAbono'];?>');"
                      onMouseOver="onMouseOverInputText(this);" onMouseOut="onMouseOutInputText(this);"
          ...
          <td colspan="2">
              <div align="left">
              <label class="nombreCampo">Total Factura</label>
              <input class="textbox1" type="text" name="lngTotalContabilidad" maxlength="10"
                     ...
                     readonly
                      />
              <input type="hidden" name="lngTotal" value="<?php if(isset($datos['Total'])){echo $datos['Total'];}else{echo '0.00';} ?>"/>
              </div>
          </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <input class="txtgeneral" type="radio" name="optTipo" value="0" 
                     <?php if(!(isset($datos['optTipo'])) || $datos['optTipo']=='0'){echo 'checked';} ?> onClick="ActivaSelecBanco(this);" tabindex="14"
                     <?php if($editarAsiento<>'SI') {?>
                     disabled="true"
                     <?php }?>
                     />
        ...
        <tr>
            ...
            <td>
                ...
                <input class="txtgeneral" type="radio" name="optTipo" value="1" 
                     <?php if($datos['optTipo']=='1'){echo 'checked';} ?> onClick="ActivaSelecBanco(this);" tabindex="15"
                     <?php if($editarAsiento<>'SI') {?>
                     disabled="true"
                     <?php }?>
                     />
            ...
            <td colspan="6"> 
                ...
                ?>
                <input class="textbox1" type="text" id="strCuentaBancos" name="strCuentaBancos" tabindex="16" 
      ...
      <P>
        ...
        <input type="Reset" class="button" value="<?php if(isset($_GET['editar']) && $_GET['editar']==='SI'){echo 'Datos Iniciales';}else{echo 'Vaciar Datos';} ?>" name="cmdReset" />
            ...
            <table border="0" style="width: 100%;">
                <tbody>
                    <tr><!-- Titulos -->
                        ...
                        <td style="width: 35%;"><label>IVA Soportado</label></td>
                    </tr>
                    <tr><!-- Esta fila se repite 4 veces: 1 -->
                      <td>
                          <div align="left">
                            <input type="text" name="lngCantidadContabilidad1" maxlength="10" tabindex="5"
                                   ...
                                   onkeyUp="CalculaIva1(this.value,document.form1.lngPorciento1.value);SumasFactura2();
                                            CalculaIRPF(document.form1.lngCantidadTotal.value,document.form1.lngPorcientoIRPF.value);TotalIRPF2();"
                                   onblur="solonumerosM(this);CalculaIva1(this.value,document.form1.lngPorciento1.value);SumasFactura2();
                                           CalculaIRPF(document.form1.lngCantidadTotal.value,document.form1.lngPorcientoIRPF.value);TotalIRPF2();formateaCantidad(this);
                                           formateaNegativoContabilidad(this,'<?php echo $_GET['esAbono'];?>');
                                           formateaNegativoContabilidad(document.form1.lngIvaContabilidad1,'<?php echo $_GET['esAbono'];?>');
                                           formateaNegativoContabilidad(document.form1.lngCantidadContabilidadTotal,'<?php echo $_GET['esAbono'];?>');
                      ...
                      <td>
                          <div align="left">
                            <input type="text" name="lngCantidadContabilidad2" maxlength="10" tabindex="5"
                                   ...
                                   style="text-align:right;font-weight:bold;" 
                                   <?php if($editarAsiento==='SI') {?>
                                   onkeyUp="CalculaIva2(this.value,document.form2.lngPorciento1.value);SumasFactura2();
                                            CalculaIRPF(document.form1.lngCantidadTotal.value,document.form1.lngPorcientoIRPF.value);TotalIRPF2();"
                                   onblur="solonumerosM(this);CalculaIva2(this.value,document.form1.lngPorciento2.value);SumasFactura2();
                                           CalculaIRPF(document.form1.lngCantidadTotal.value,document.form1.lngPorcientoIRPF.value);TotalIRPF2();formateaCantidad(this);
                                           formateaNegativoContabilidad(this,'<?php echo $_GET['esAbono'];?>');
                                           formateaNegativoContabilidad(document.form1.lngIvaContabilidad2,'<?php echo $_GET['esAbono'];?>');
                                           formateaNegativoContabilidad(document.form1.lngCantidadContabilidadTotal,'<?php echo $_GET['esAbono'];?>');
                      ...
                      <td>
                          <div align="left">
                            <input type="text" name="lngCantidadContabilidad3" maxlength="10" tabindex="5"
                                   ...
                                   onkeyUp="CalculaIva3(this.value,document.form1.lngPorciento3.value);SumasFactura2();
                                            CalculaIRPF(document.form1.lngCantidadTotal.value,document.form1.lngPorcientoIRPF.value);TotalIRPF2();"
                                   onblur="solonumerosM(this);CalculaIva3(this.value,document.form1.lngPorciento3.value);SumasFactura2();
                                           CalculaIRPF(document.form1.lngCantidadTotal.value,document.form1.lngPorcientoIRPF.value);TotalIRPF2();formateaCantidad(this);
                                           formateaNegativoContabilidad(this,'<?php echo $_GET['esAbono'];?>');
                                           formateaNegativoContabilidad(document.form1.lngIvaContabilidad3,'<?php echo $_GET['esAbono'];?>');
                                           formateaNegativoContabilidad(document.form1.lngCantidadContabilidadTotal,'<?php echo $_GET['esAbono'];?>');
                      ...
                      <td>
                          <div align="left">
                            <input type="text" name="lngCantidadContabilidad4" maxlength="10" tabindex="5"
                                   ...
                                   onkeyUp="CalculaIva4(this.value,document.form1.lngPorciento4.value);SumasFactura2();
                                            CalculaIRPF(document.form1.lngCantidadTotal.value,document.form1.lngPorcientoIRPF.value);TotalIRPF2();"
                                   onblur="solonumerosM(this);CalculaIva4(this.value,document.form1.lngPorciento4.value);SumasFactura2();
                                           CalculaIRPF(document.form1.lngCantidadTotal.value,document.form1.lngPorcientoIRPF.value);TotalIRPF2();formateaCantidad(this);
                                           formateaNegativoContabilidad(this,'<?php echo $_GET['esAbono'];?>');
                                           formateaNegativoContabilidad(document.form1.lngIvaContabilidad4,'<?php echo $_GET['esAbono'];?>');
                                           formateaNegativoContabilidad(document.form1.lngCantidadContabilidadTotal,'<?php echo $_GET['esAbono'];?>');
                    ...
                    <tr>
                        <td colspan="2">
                            <div align="left">
                                <label>% IRPF</label>
                                <select name="lngPorcientoIRPF"
                                        style="text-align:right;font-weight:bold;width:50%;" tabindex="13"
                                     <?php if($editarAsiento==='SI') {?>
                                        onchange="CalculaIva1(document.form1.lngCantidad1.value,document.form1.lngPorciento1.value);
                                                  CalculaIRPF(document.form1.lngCantidadTotal.value,this.value);TotalIRPF2();
                                                  formateaNegativoContabilidad(document.form1.lngIvaContabilidad1,'<?php echo $_GET['esAbono'];?>');
                    ...
                    <tr>
                      <td colspan="2">
                          <div align="left">
                            ...
                            <input type="text" name="lngTotalContabilidad" maxlength="10"
                                   style="text-align:right;font-weight:bold;"
                                   value="<?php if(isset($datos['ContabilidadTotal'])){echo $datos['ContabilidadTotal'];}else{echo '0,00';} ?>"
                                   readonly
                                    />

...
if(isset($_POST['cmdAlta']) && $_POST['cmdAlta']=='Alta'){
    logger('info',basename($_SERVER['PHP_SELF']).'-' ,"Usuario: ".$_SESSION['strUsuario'].', Empresa: '.$_SESSION['strBD'].', SesionID: '.  session_id().
           " ||||Operaciones->Mis Gastos|| Ha pulsado 'Aceptar'(ConFactura+IVA1+ConRetencionIRPF)");

    //print_r($_POST);die;
    //guardo el gasto el la tabla tbmovimientos, tbacumulados y tbmovimientos_iva
    $varRes = $clsCNContabilidad->AltaGastosMovimientosIRPF(0,$_SESSION["idEmp"],$_POST['strCuenta'],$_POST['strCuentaCli'],
    ...
    logger('warning','' ,
           ' $clsCNContabilidad->AltaGastosMovimientosIRPF(0,'.$_SESSION["idEmp"].",'".$_POST['strCuenta']."','".$_POST['strCuentaCli']."','".
                                            $_POST["lngCantidad1"]."','".$_POST["lngIva1"]."','".$_POST["lngPorciento1"]."','".
                                            $_POST["lngIRPF"]."','".$_POST["lngPorcientoIRPF"]."','".$_POST["datFecha"]."','".
                                            $_POST['optTipo']."','".$_POST['strCuentaBancos']."','".$_POST["lngPeriodo"]."','".$_POST["strPeriodo"]."','".
                                            $_POST["lngEjercicio"]."','". addslashes($_POST["strConcepto"])."','". $_POST['esAbono']."','". $_SESSION["strUsuario"]."');");
...
//        echo '<META HTTP-EQUIV=Refresh CONTENT="0; URL=../vista/gastos_exito.php?op=CFIVA1CIRPF&datos='.$compactada.'&esAbono='.$_POST["esAbono"].'">';
        echo '<META HTTP-EQUIV=Refresh CONTENT="0; URL=../vista/gastos_exito.php?op=CFIVA1CIRPF&tipo='.$_POST['tipo'].'">';
    }
...
?>
  <div class="doc"> 
    <hr color = "#FF9900">
    <br/>
    <form name="form1" method="post" action="../vista/gastos_CFIVA1CIRPF.php">
      ...
      <table width="640" border="0" class="zonaactiva">
        ...
        <tr> 
          <td colspan="6"> 
              ...
              ?>
              <input class="textbox1" type="text" id="strCuenta" name="strCuenta" tabindex="2" value="<?php echo htmlentities($datos['strCuenta'],ENT_QUOTES,'UTF-8');?>"
                   <?php if($editarAsiento==='SI') {?>
          ...
          <td colspan="4">
              ...
              <input class="textbox1" type="text" id="strCuentaCli" name="strCuentaCli" tabindex="3" value="<?php echo htmlentities($datos['strCuentaCli'],ENT_QUOTES,'UTF-8');?>"
                   <?php if($editarAsiento==='SI') {?>
        ...
        <tr>
          ...
          <td colspan="3">
              <div align="right">
              <label class="nombreCampo">% IRPF<font color="#FFFFFF">...............</font> </label><br/>
                ...
                <tbody>
                    ...
                    <tr>
                      <td colspan="2">
                          <div align="left">
                            <label>% IRPF</label>
                                <select name="lngPorcientoIRPF" style="text-align:right;font-weight:bold;width:50%;" tabindex="7"
                                     <?php if($editarAsiento==='SI') {?>
                                        onchange="CalculaIva1(document.form1.lngCantidad1.value,document.form1.lngPorciento1.value);
                                                  CalculaIRPF(document.form1.lngCantidad1.value,this.value);TotalIRPF();
                                                  formateaNegativoContabilidad(document.form1.lngIvaContabilidad1,'<?php echo $_GET['esAbono'];?>');

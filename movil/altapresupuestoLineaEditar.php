...
?>
    ...
    <div data-role="content" data-theme="a">
        <form id="form1" name="form1" method="post" action="../movil/altapresupuestoLineaEditar.php"  data-ajax="false">
                ...
                <tr>
                    ...
                    <td colspan="2">
                        ...
                        <input type="text" name="precio" maxlength="12" id="precio"
                               onfocus="onFocusInputTextM(this);desFormateaCantidadHidden(this,document.form1.precioHidden);" 
                               onkeypress="DesactivaImprimir();" onkeyup="DesactivaImprimir();"
                               onblur="solonumerosM(this);
                ...
                <tr>
                    <td colspan="4">
                        ...
                        <textarea id="concepto" name="concepto" rows=4 cols="20" onfocus="javascript:document.form1.concepto.style.borderColor='#aaa666';"
                                  onkeypress="DesactivaImprimir();" onkeyup="DesactivaImprimir();"
                                  onblur="SiEsArticuloRellenar(this,document.form1.IdArticulo,document.form1.cantidadHidden,document.form1.precio,document.form1.precioHidden,document.form1.importe,document.form1.iva,document.form1.cuota,document.form1.total,document.form1.esValido);"
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <input type="button" data-icon="back" value = "Volver" data-mini="true"
                               onclick="javascript:window.location='../movil/altapresupuestoLineas.php';" data-theme="a" />
                    </td>
                </tr>
            </tbody>
        </table>    

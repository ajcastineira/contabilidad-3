    ...
    <td bgcolor="#FFFFFF" align ="center" valign="top">
	  <br><br>
       ...
       <?php if(isset($_SESSION['logo'])){ ?>
          <div align="center"><a href="../vista/default2.php"><IMG height=67 alt="Ir al menú" src="../images/<?php echo $_SESSION["logo"]; ?>" width=132 border="0"></a></div></td> 
       <?php }else{ ?>
          <div align="center"><a href="../vista/default2.php"><IMG height=67 alt="Ir al menú" src="../images/logo-Qualidad.JPG" width=132 border="0"></a></div></td> 
       <?php } ?>
     </td> 
  </tr>

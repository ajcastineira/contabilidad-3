...
function nuevoCliente(){
    ...
    if(tipo==='cliente'){
        window.location='../vista/altacliprov.php?tipo=cliente';
    }else if(tipo==='proveedor'){
        window.location='../vista/altacliprov.php?tipo=proveedor';
    }    
}
...
<!--              </a>-->
      ...
      <td width="40%">
          <div align="lef">
              <input class="button" type="button" name="eleccion" value="Nuevo <?php echo $_GET['tipo'];?>" onclick="nuevoCliente();"/>
          </div>
      </td>
  </tr>
  <tr>        
     <td colspan="3" align = center>
       <br><br>	
          <div align="center"><IMG height=67 alt="Ir al menú" src="../images/logo-<?php echo $_SESSION["base"]; ?>.jpg" width=132 border="0"></div></td> 
      </td> 
  </tr>
